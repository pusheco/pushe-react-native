...
public class RNPusheWritable {
    ...
    public WritableMap notificationDataToWritableMap(NotificationData notificationData, NotificationButtonData clickedButton) {
        WritableMap writableMap = new WritableNativeMap();
        ...
        WritableMap map = new WritableNativeMap();
        map.putString("id", clickedButton.getId());
        map.putString("icon", clickedButton.getIcon());
        map.putString("text", clickedButton.getText());
        
        writableMap.putMap("clickedButton", map);
