...
public class RNPusheIntent {
    ...
    public Intent getNotificationIntent(Context context, NotificationData notificationData, NotificationButtonData clickedButton) {
        Intent intent = new Intent(context, RNPusheNotificationService.class);
        ...
        map.put("id", clickedButton.getId());
        map.put("icon", clickedButton.getIcon());
        map.put("text", clickedButton.getText());
        intent.putExtra("clickedButton", mapToBundle(map));
